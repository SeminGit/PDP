...
export default class Filter extends LightningElement {
    ...
    connectedCallback() {
        FilterService.getAvailableOperators(this.type)
            .then(result => {
    ...
    fireFilter() {
        const filter = FilterService.create(this.type, this.field, this.value, this.operator);
        EventService.fireFilterChangedEvent(this, filter);
    }
